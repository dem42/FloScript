...
public class FirstDiagramTutorialPageFragment extends PageSupportFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mVideoView.setVideoURI(ResourceAndFileUtils.getRawFileUri(this.getActivity().getPackageName(), R.raw.test_video3));
